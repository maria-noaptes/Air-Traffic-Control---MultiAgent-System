...
namespace Reactive
{
    public class Utils
    {
        public static int NoExplorers = Int32.Parse(ConfigurationManager.AppSettings["noExplorers"]);
        ...
        */
        ...
        public class Point
        {
            ...
            {
                // Console.WriteLine("(a.a * b.a + a.b * b.b + a.c * b.c) "+ (a.a * b.a + a.b * b.b + a.c * b.c));
            ...
            {
                Console.WriteLine("vals " + Math.Acos(dotProductVectors(a, b) / (magnitudeVector(a) * magnitudeVector(b))) + " " + dotProductVectors(a, b) / (magnitudeVector(a) * magnitudeVector(b)));
...
namespace Reactive
{
    public class Utils
    {
        ...
        public class Point
        {
            ...
            public static double getAngle(Point a, Point b) // the transformed dot product equation
            {
                Console.WriteLine("Math.Acos(dotProductVectors(a, b) " + Math.Acos(dotProductVectors(a, b)) + " " + (magnitudeVector(a) * magnitudeVector(b)));
                return Math.Acos(dotProductVectors(a, b) / (magnitudeVector(a) * magnitudeVector(b)));
            }
            public static Point generateRandomAirplanePosition()  // airplanes should be on the circle radius
            {
